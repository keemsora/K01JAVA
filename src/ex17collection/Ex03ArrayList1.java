...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		1-3] 리스트 컬렉션 출력하기(for, 확장 for문)
			컬렉션을 다룰 때는 주로 확장for(for-each)문을 주로 사용한다.
		 */
		System.out.println("\n[일반for문 사용]");
		...
		/*
		1-4] 덮어쓰기
			set(인덱스, 객체) : 특정 인덱스에 저장된 데이터를 덮어쓰게되므로 기존 자료는 삭제된다.
		 */
		...
		방법1 : 인덱스로 삭제하기
			remove(index) : 인덱스를 통해서 삭제를 진행한 후 삭제가 완료되면 해당 객체를 반환한다.
				삭제 후에는 인덱스가 자동으로 재부여된다. 삭제 성공 시 해당 객체를 반환하므로 
