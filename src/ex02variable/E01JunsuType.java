...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		- 단, byte와 short는 예외적인 상황으로 생각하면 된다.(int형에 최적화된 CPU의 특성 때문)
		 */
		...
		//long long = 2200000000; => 에러발생
		long long3 = 2200000000L;
		//long long4 = 2100000000l;
		/*
