...
람다식(Lambda Expression) 
	...
	이러한 불편함 때문에 최근 함수형프로그래밍(functional programming)의 장점이
	대두되었고, 이런 단점을 보안하기 위해 JDK1.8부터 지원하게 되었다.
 */
interface IKosmo3 {
...
public class Ex03Lambda {
	public static void main(String[] args) {
		...
		- 매개변수의 타입을 옛아할 수 있다면 생략 가능
		- 매개변수가 하나라면 소괄호도 생략 가능
		- 실행할 문장이 하나이고, 동시에 return문이 아니라면 중괄호도 생략 가능
		 */
