...
public class Ex06Define2Supplier {
	...
	//난수를 생성해서 반환하는 람다식을 매개변수로 받아 cnt개의 난수를 반환
	...
	/*
	Supplier<T>
		: 공급자란 의미를 가지고 있고 매개변수는 없으나 리턴값이 있는 get()메소드가 정의되어있다.
		주로 실행 후 호출한 곳으로 데이터를 생성한 후 변환한다.
	 */
	public static void main(String[] args) {
		 ...
		 */
		/*
		위의 get()메소드를 오버라이딩하여 0~99사이의 난수를 반환하는 람다식 정의함 
		 */
