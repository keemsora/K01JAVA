...
interface IKosmo1{
	...
	/*
	인터페이스에서 정의된 메소드는 public abstract로 선언된다.
	 */
	void stduyLambda(String str);
}
class KosmoStudent1 implements IKosmo1{
	
	/*
	인터페이스를 구현 받았으므로 반드시 추상메소드를 오버라이딩 해야 한다.
	 */
	@Override
	public void stduyLambda(String str) {
