...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		/*
		6] contains()
			: 문자열에 특정 문자열이 포함되어 있는지를 판단하여 포함되어있으면 true를 반환한다.
		 */
		...
		/*
		11] lastIndexOf()
			: 사용법은 indexOf()와 동일하나 문자열의 뒤에서부터 문자열을 찾아서 
			인덱스를 반환한다. 
		 */
		...
		14] substring()
			...
			사용 1: substring(index) -> 이 경우 index부터 문자열의 끝까지를 잘라서 반환
			사용 2: substring(index1, index2) -> 인덱스에 포함되는 부분만 잘라서 반환
		 */
		 ...
		 */
		String filename = "my.life.images.jpg";
