...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		자바에서는 배열을 객체를 통해 생성하게 된다. 생성된 배열은 Heap(힙)영역에 저장되고
		할당된 메모리의 주소값을 반환한다. 그래서 배열명(배열변수)는 주소값(참조값)을
		...
		System.out.println("배열명(numArr)="+ numArr);//I@15db9742->참조값
		...
		크기를 결정할 수 있으므로 이런 경우 크기는 생략하도록 약속되어있다.
		 */
