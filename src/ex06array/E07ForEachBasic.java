...
for-each문
	...
	그러므로 참조의 목적으로만 사용하해야 하고, 값의 변경은 기본적으로 허용하지 않는다.
	형식]
		for(자료형 참조변수 : 배열이름) {
			실행문장;
...
public class E07ForEachBasic {
	...
	public static void main(String[] args) {
		...
		/*
		배열 arr의 요소를 하나씩 참조하여 출력하고, 더이상 참조할 요소가 없을 때
		for문이 자동으로 종료된다.
		 */
		sum=0;
		for(int e : arr) {
		...
		/*
		2차원배열은 1차원배열 여러개를 쌓아놓은 형태이므로 출력 시에는 우선 하나의 행(1차원배열)을 가져와서
		각 요소를 하나씩 참조하여 출력한다. 
		 */
