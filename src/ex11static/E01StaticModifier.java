...
- main() 메소드가 실행되기 전에 이미 초기화되므로
	main메소드 실행 시 별도의 선언없이 변수를 사용할 수 있다.
...
class MyStatic {
	...
	/*
	정적 멤버메소드] 정적메소드 안에서는 인스턴스 멤버를 사용할 수 없다. 정적멤버만 접근이 가능하다.
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		정적 멤버변수는 각각의 객체마다 멤버변수가 존재하지 않고,
		메소드영역에 하나만 생성되어 공유되므로, 아래 대입문장은 하나의 변수에 값이 할당되게 된다.
